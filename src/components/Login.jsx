    ...
    return (
        <>
            <div className="text-center mt-24">
                ...
                <span className="text-sm">or  <NavLink to={'/signin'} className={"link text-blue-500"}>Register a new account</NavLink>
                </span>
            </div>
                ...
                <form className="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div className="w-full md:w-full px-3 mb-4">
                            ...
                            <input className="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" type='password' required onChange={handlePasswordChange}/>
                        </div>
                        {ShouldContainDigit && <div className='px-3 text-sm text-red-600 italic mb-2'> *Password must contain digits</div>}
